...
/datum/action/bloodsucker/targeted/tremere
	...
	button_icon = 'ModularRail/bloodsuckers/icons/actions_tremere_bloodsucker.dmi'
	background_icon = 'ModularRail/bloodsuckers/icons/actions_tremere_bloodsucker.dmi'
