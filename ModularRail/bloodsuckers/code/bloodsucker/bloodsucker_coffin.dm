...
/obj/structure/closet/crate/coffin/blackcoffin
	...
	icon_state = "coffin"
	icon = 'ModularRail/bloodsuckers/icons/vamp_obj.dmi'
	open_sound = 'ModularRail/bloodsuckers/sounds/coffin_open.ogg'
	close_sound = 'ModularRail/bloodsuckers/sounds/coffin_close.ogg'
	breakout_time = 30 SECONDS
	pry_lid_timer = 20 SECONDS
	resistance_flags = NONE
	material_drop = /obj/item/stack/sheet/iron
	material_drop_amount = 2
	armor_type = /datum/armor/coffin/blackcoffin

/datum/armor/coffin/blackcoffin
	melee = 50
	bullet = 20
	laser = 30
	bomb = 50
...
/obj/structure/closet/crate/coffin/securecoffin
	...
	material_drop = /obj/item/stack/sheet/iron
	material_drop_amount = 2
	armor_type = /datum/armor/coffin/securecoffin

/datum/armor/coffin/securecoffin
	melee = 35
	bullet = 20
	laser = 20
	bomb = 100
...
/obj/structure/closet/crate/coffin/meatcoffin
	...
	armor_type = /datum/armor/coffin/meat

/datum/armor/coffin/meat
	melee = 70
	bullet = 10
	laser = 10
	bomb = 70
...
/obj/structure/closet/crate/coffin/metalcoffin
	...
	armor_type = /datum/armor/coffin/metal

/datum/armor/coffin/metal
	melee = 40
	bullet = 15
	laser = 50
	bomb = 10
...
/obj/structure/closet/crate/proc/LockMe(mob/user, inLocked = TRUE)
	if(user == resident)
		...
		if(!do_after(resident, src, 5 SECONDS))
