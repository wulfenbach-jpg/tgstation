...
/obj/item/clothing/head/wizard/magus/necromancer
	...
	armor_type = /datum/armor/necromancer
...
/obj/item/clothing/suit/wizrobe/necromancer
	...
	icon = 'ModularRail/tomb/magicon.dmi'
	worn_icon = 'ModularRail/tomb/suitmob.dmi'
