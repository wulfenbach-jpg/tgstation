/obj/item/gun/ballistic/tribalbow
	...
	icon = 'ModularRail/tribal_extended/icons/projectile.dmi'
	lefthand_file = 'ModularRail/tribal_extended/icons/bows_lefthand.dmi'
	righthand_file = 'ModularRail/tribal_extended/icons/bows_righthand.dmi'
	worn_icon = 'ModularRail/tribal_extended/icons/back.dmi'
	...
	fire_sound = 'ModularRail/tribal_extended/sound/sound_weapons_bowfire.ogg'
...
/obj/item/gun/ballistic/tribalbow/attack_self(mob/living/user)
	if (chambered)
		...
		if (do_mob(user,I,10))
			...
			playsound(src, 'ModularRail/tribal_extended/sound/sound_weapons_bowdraw.ogg', 75, 0) //gets way too high pitched if the freq varies
			chamber_round()
	update_icon()
