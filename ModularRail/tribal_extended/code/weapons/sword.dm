/obj/item/claymore/bone
	...
	icon = 'ModularRail/tribal_extended/icons/items_and_weapons.dmi'
	lefthand_file = 'ModularRail/tribal_extended/icons/swords_lefthand.dmi'
	righthand_file = 'ModularRail/tribal_extended/icons/swords_righthand.dmi'
