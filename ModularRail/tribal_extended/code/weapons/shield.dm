/obj/item/shield/goliath
	...
	icon = 'ModularRail/tribal_extended/icons/shields.dmi'
	icon_state = "goliath_shield"
	lefthand_file = 'ModularRail/tribal_extended/icons/shields_lefthand.dmi'
	righthand_file = 'ModularRail/tribal_extended/icons/shields_righthand.dmi'
